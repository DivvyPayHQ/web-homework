defmodule HomeworkWeb.Resolvers.MerchantsResolver do
  ...
  """
  def create_merchant(_root, %{input: %{} = params}, _info) do
  ...
  """
  def update_merchant(_root, %{input: %{} = params}, _info) do
    merchant = Merchants.get_merchant!(params.id)

    case Merchants.update_merchant(merchant, params) do
      {:ok, merchant} ->
        {:ok, merchant}
