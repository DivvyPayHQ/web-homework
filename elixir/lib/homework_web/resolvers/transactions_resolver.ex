defmodule HomeworkWeb.Resolvers.TransactionsResolver do
  ...
  """
  def create_transaction(_root, %{input: %{} = params}, _info) do
  ...
  """
  def update_transaction(_root, %{input: %{} = params}, _info) do
    transaction = Transactions.get_transaction!(params.id)
